...
def sentence3() -> Expr:
    ...
    Expr3 = PacmanBorn_0
    return conjoin(Expr1, Expr2, Expr3)
    # return PropSymbolExpr("Test", 1, 2, 3, time=0)
...
#     """
#     "*** BEGIN YOUR CODE HERE ***"
#     PremiseVals = findModel(premise)
#     ConclusionVals = findModel(conclusion)
#     if (PremiseVals == False or ConclusionVals == False):
#         # unsatisfiable condition
#         return False 
#     # print("Premise vals: ", PremiseVals)
#     # print("Conclusion vals: ", ConclusionVals)
#     if (type(ConclusionVals) == dict and type(PremiseVals) == dict):
#         print("case 1")
#         print("Premise keys: ", PremiseVals.keys())
#         print("Conclusion keys: ", ConclusionVals.keys())
#         ConclusionKeys = ConclusionVals.keys()
#         if (len(PremiseVals) != len(ConclusionVals)):
#             return False
#         for key in PremiseVals:
#             # print("key: ", key)
#             if (key not in ConclusionKeys):
#                 return False
#             if (PremiseVals[key] == True and ConclusionVals[key] == False):
#                 return False
#         return True
#     elif (type(PremiseVals) == dict and type(ConclusionVals) == bool):
#         print("case 2")
#         # print("Premise vals: ", type(PremiseVals))
#         # print("Conclusion vals: ", type(ConclusionVals))
#         for key in PremiseVals:
#             if (PremiseVals[key] == True and ConclusionVals == False):
#                 return False
#         return True
#     elif (type(PremiseVals) == bool and type(ConclusionVals) == dict):
#         print("case 3")
#         # print("Premise vals: ", type(PremiseVals))
#         # print("Conclusion vals: ", type(ConclusionVals))
#         for key in ConclusionVals:
#             if (PremiseVals == True and ConclusionVals[key] == False):
#                 return False
#         return True
#     elif (type(PremiseVals) == bool and type(ConclusionVals) == bool):
#         print("case 4")
#         if PremiseVals == True and ConclusionVals == False:
#             return False
#         return True
#     else:
#         print("case 5")
...
#         return False 
#     if (type(ConclusionVals) == dict and type(PremiseVals) == dict):
#         if (len(PremiseVals) == 0 or len(ConclusionVals) == 0):
#             print("2")
#             return False
#         ConclusionKeys = ConclusionVals.keys()
#         # if (len(PremiseVals) != len(ConclusionVals)):
...
#         #     return False
#         # print(PremiseVals)
#         # print(ConclusionVals)
#         for key in PremiseVals:
#             if (key not in ConclusionKeys and PremiseVals[key] == True):
#                 print("4")
#                 return False
#             # if (PremiseVals[key] == True and ConclusionVals[key] == False):
#             #     print("4")
#             #     return False
#             if (key in ConclusionKeys):
#                 if (PremiseVals[key] == True and ConclusionVals[key] == False):
#                     print("5")
#                     return False
#             # elif (PremiseVals[key] == False and ConclusionVals[key] != False):
#             #     return False
#         return True
#     elif (type(PremiseVals) == dict and type(ConclusionVals) == bool):
#         if (len(PremiseVals) == 0):
#             print("6")
#             return False
#         for key in PremiseVals:
#             if (PremiseVals[key] == True and ConclusionVals == False):
#                 print("7")
#                 return False
#             # elif (PremiseVals[key] == False and ConclusionVals != False):
#             #     return False
#         return True
#     elif (type(PremiseVals) == bool and type(ConclusionVals) == dict):
#         if (len(ConclusionVals) == 0):
#             print("8")
#             return False
#         if (PremiseVals == False):
#             print("9")
#             return False # here?
#         for key in ConclusionVals:
#             if (PremiseVals == True and ConclusionVals[key] == False):
#                 print("10")
#                 return False
#             # elif (PremiseVals == False and ConclusionVals[key] != False):
#             #     return False
#         return True
#     elif (type(PremiseVals) == bool and type(ConclusionVals) == bool):
#         if PremiseVals == True and ConclusionVals == False:
...
#         elif PremiseVals == False and ConclusionVals != False:
#             return False
#         return True
#     else:
#         print("case 5")
...
#         # x = 1
#         print((premise >> conclusion) , " with input: ", input, "and result: ", result, " and entails: ", status, "; hit ", placement)
...
#         printResult(False, 2)
#         return False
#     # print((premise >> conclusion) , " with result: ", result)
#     # if (result == False and input == False):
#     #     printResult(True, 1)
#     #     return True
#     # if (result == False): // input
#     #     printResult(False, 2)
#     #     return False
#     if (type(input) == dict and type(result) == dict):
#         # resultKeys = result.keys()
#         inputKeys = input.keys()
#         for key in inputKeys:
#             if input[key] == True and result[key] == False:
#                 printResult(False, 3)
#                 return False
#     elif (type(input) == bool and type(result) == dict):
#         # resultKeys = result.keys()
#         # for key in resultKeys:
#         #     # if input == False and result[key] != False:
#         #     #     print("hit 1")
#         #     #     return False
#         #     # elif input == True and result[key] == False:
#         #     #     return False
#         #     if input == True and result[key] == False:
#         #         printResult(False, 4)
#         #         return False
#         printResult(True, 4)
#         return True
#     elif (type(input) == dict and type(result) == bool):
#         # result has to be true regardless, so this is true
#         if (result == False):
#             return False
#         printResult(True, 5)
#         return True
#     elif (type(input) == bool and type(result) == bool):
...
#     def printResult(status, placement):
#         # x = 1
#         print((premise >> conclusion) , " with input: ", input, "and proceeds: ", proceed, " and entails: ", status, "; hit ", placement)
#     result = findModel(premise >> conclusion)
#     input = findModel(premise)
#     proceed = findModel(conclusion)
#     if (input == False and result == False):
#         printResult(True, 0)
#         return True
#     elif (input == False and result == True):
#         printResult(True, 1)
#         return True
#     elif (input == True and result == False):
#         printResult(False, 0)
#         return False
#     elif (input == True and result == True):
#         printResult(True, 2)
#         return True
#     # print((premise >> conclusion) , " with result: ", result)
#     # if (result == False and input == False):
...
#     #     printResult(False, 2)
#     #     return False
#     if (type(input) == dict and type(proceed) == dict):
#         # resultKeys = result.keys()
#         inputKeys = input.keys()
#         for key in inputKeys:
#             if key in proceed:
#                 if input[key] == True and proceed[key] == False:
#                     printResult(False, 3)
#                     return False
#     elif (type(input) == bool and type(proceed) == dict):
#         # resultKeys = result.keys()
#         # for key in resultKeys:
#         #     # if input == False and result[key] != False:
#         #     #     print("hit 1")
...
#         printResult(True, 4)
#         return True
#     elif (type(input) == dict and type(proceed) == bool):
#         # result has to be true regardless, so this is true
#         if (proceed == False):
#             return False
#         printResult(True, 5)
#         return True
#     elif (type(input) == bool and type(proceed) == bool):
